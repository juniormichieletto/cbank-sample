...
type PaymentRequest struct {
	...
	CreditCard  *CreditCart `protobuf:"bytes,1,opt,name=creditCard,proto3" json:"creditCard,omitempty"`
...
func (x *PaymentRequest) GetCreditCard() *CreditCart {
	if x != nil {
		return x.CreditCard
	}
	return nil
...
func (x *CreditCart) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreditCart) ProtoMessage() {}

func (x *CreditCart) ProtoReflect() protoreflect.Message {
	mi := &file_protofile_payment_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreditCart.ProtoReflect.Descriptor instead.
func (*CreditCart) Descriptor() ([]byte, []int) {
	return file_protofile_payment_proto_rawDescGZIP(), []int{1}
}

func (x *CreditCart) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *CreditCart) GetNumber() string {
	if x != nil {
		return x.Number
	}
	return ""
...
func (x *CreditCart) GetExpirationMonth() int32 {
	if x != nil {
...
func (x *CreditCart) GetExpirationYear() int32 {
	if x != nil {
...
func (x *CreditCart) GetCvv() int32 {
	if x != nil {
		return x.Cvv
	}
	return 0
...
var file_protofile_payment_proto_rawDesc = []byte{
	...
	0x2e, 0x43, 0x72, 0x65, 0x64, 0x69, 0x74, 0x43, 0x61, 0x72, 0x74, 0x52, 0x0a, 0x63, 0x72, 0x65,
	...
	0x69, 0x74, 0x43, 0x61, 0x72, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01,
...
var file_protofile_payment_proto_goTypes = []interface{}{
	...
	(*CreditCart)(nil),     // 1: payment.CreditCart
	(*empty.Empty)(nil),    // 2: google.protobuf.Empty
}
var file_protofile_payment_proto_depIdxs = []int32{
	1, // 0: payment.PaymentRequest.creditCard:type_name -> payment.CreditCart
